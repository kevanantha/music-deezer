...
;(function($, undefined) {
  ...
  jPlayerPlaylist.prototype = {
    ...
    option: function(option, value) {
      // For changing playlist options only
      if (value === undefined) {
    ...
    _createListItem: function(media) {
      ...
      if (media.free) {
        ...
        $.each(media, function(property, value) {
          if ($.jPlayer.prototype.format[property]) {
            ...
            listItem +=
              "<a class='" +
              self.options.playlistOptions.freeItemClass +
              "' href='" +
              value +
              "' tabindex='-1'>" +
              property +
      ...
      listItem +=
        ...
        "' tabindex='0'>" +
        media.title +
        (media.artist ? " <span class='jp-artist'>by " + media.artist + '</span>' : '') +
        '</a>'
      listItem += '</div></li>'
      ...
      $(this.cssSelector.playlist)
        ...
        .on('click', 'a.' + this.options.playlistOptions.freeItemClass, function(e) {
          ...
          $(this)
            .parent()
            .parent()
            .find('.' + self.options.playlistOptions.itemClass)
            .click()
          self.blur(this)
        })
    ...
    _highlight: function(index) {
      if (this.playlist.length && index !== undefined) {
        ...
        $(this.cssSelector.playlist + ' li:nth-child(' + (index + 1) + ')')
              ...
              function() {
                ...
                if (self.original.length) {
                  if (index === self.current) {
                    self.current =
                      index < self.original.length ? self.current : self.original.length - 1 // To cope when last element being selected when it was removed
                    self.select(self.current)
